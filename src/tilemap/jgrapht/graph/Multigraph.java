    ...
    implements UndirectedGraph<V, E>
{
    ...
    public static <V, E> UndirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.Multigraph<V, E>, ?> builder(Class<? extends E> edgeClass)
    {
        return new UndirectedGraphBuilder<V, E, tilemap.jgrapht.graph.Multigraph<V, E>>(
            new tilemap.jgrapht.graph.Multigraph<V, E>(edgeClass));
    }

    public static <V, E> UndirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.Multigraph<V, E>, ?> builder(EdgeFactory<V, E> ef)
    {
        return new UndirectedGraphBuilder<V, E, tilemap.jgrapht.graph.Multigraph<V, E>>(
            new tilemap.jgrapht.graph.Multigraph<V, E>(ef));
    }
}
