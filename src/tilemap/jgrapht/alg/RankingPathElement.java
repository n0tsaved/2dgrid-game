    ...
    extends AbstractPathElement<V, E>
{
    ...
    RankingPathElement(
        Graph<V, E> graph,
        tilemap.jgrapht.alg.RankingPathElement<V, E> pathElement,
        E edge,
        double weight)
    {
     ...
     */
    @Override public tilemap.jgrapht.alg.RankingPathElement<V, E> getPrevPathElement()
    {
        return (tilemap.jgrapht.alg.RankingPathElement<V, E>) super.getPrevPathElement();
    }
}
