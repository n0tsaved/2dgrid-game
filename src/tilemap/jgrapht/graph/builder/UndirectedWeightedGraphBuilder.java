...
public final class UndirectedWeightedGraphBuilder<V,
    ...
    extends UndirectedWeightedGraphBuilderBase<V,
        E, G, tilemap.jgrapht.graph.builder.UndirectedWeightedGraphBuilder<V, E, G>>
{
    ...
    @Override protected tilemap.jgrapht.graph.builder.UndirectedWeightedGraphBuilder<V, E, G> self()
    {
        return this;
    }
}
