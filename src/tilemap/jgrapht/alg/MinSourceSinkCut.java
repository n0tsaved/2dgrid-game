...
import tilemap.jgrapht.alg.interfaces.MaximumFlowAlgorithm.MaximumFlow;
import tilemap.jgrapht.DirectedGraph;
import tilemap.jgrapht.Graphs;
import tilemap.jgrapht.alg.flow.EdmondsKarpMaximumFlow;
...
public class MinSourceSinkCut<V, E>
{
    ...
    {
        this.ekMaxFlow = new tilemap.jgrapht.alg.flow.EdmondsKarpMaximumFlow<V, E>(graph);
        this.graph = graph;
