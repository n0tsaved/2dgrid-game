...
/**
 * The most general implementation of the {@link tilemap.jgrapht.Graph} interface.
        ...
        Serializable
{
    ...
    {
        try {
            TypeUtil<tilemap.jgrapht.graph.AbstractBaseGraph<V, E>> typeDecl = null;

            tilemap.jgrapht.graph.AbstractBaseGraph<V, E> newGraph =
