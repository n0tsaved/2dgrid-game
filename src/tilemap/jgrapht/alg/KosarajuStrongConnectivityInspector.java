...
import tilemap.jgrapht.alg.interfaces.StrongConnectivityAlgorithm;

import java.util.*;


/**
 * <p>Complements the {@link tilemap.jgrapht.alg.ConnectivityInspector} class with
 ...
 *
 * <p>Unlike {@link tilemap.jgrapht.alg.ConnectivityInspector}, this class does not
 * implement incremental inspection. The full algorithm is executed at the first
 * call of {@link tilemap.jgrapht.alg.KosarajuStrongConnectivityInspector#stronglyConnectedSets()} or {@link
 * tilemap.jgrapht.alg.KosarajuStrongConnectivityInspector#isStronglyConnected()}.</p>
 *
...
public class KosarajuStrongConnectivityInspector<V, E> implements StrongConnectivityAlgorithm<V,E>
{
     ...
     * tilemap.jgrapht.alg.KosarajuStrongConnectivityInspector#stronglyConnectedSets()}. If you don't need
