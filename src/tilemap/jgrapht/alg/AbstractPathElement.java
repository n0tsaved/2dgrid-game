...
abstract class AbstractPathElement<V, E>
{
     ...
     */
    protected tilemap.jgrapht.alg.AbstractPathElement<V, E> prevPathElement;
    ...
    protected AbstractPathElement(
        Graph<V, E> graph,
        tilemap.jgrapht.alg.AbstractPathElement<V, E> pathElement,
        E edge)
    {
        this.vertex =
     ...
     */
    protected AbstractPathElement(tilemap.jgrapht.alg.AbstractPathElement<V, E> original)
    {
    ...
    public List<E> createEdgeListPath()
    {
        ...
        tilemap.jgrapht.alg.AbstractPathElement<V, E> pathElement = this;
     ...
     */
    public tilemap.jgrapht.alg.AbstractPathElement<V, E> getPrevPathElement()
    {
