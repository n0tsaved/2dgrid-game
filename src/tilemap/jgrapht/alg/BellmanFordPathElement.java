    ...
    extends AbstractPathElement<V, E>
{
    ...
    protected BellmanFordPathElement(
        Graph<V, E> graph,
        tilemap.jgrapht.alg.BellmanFordPathElement<V, E> pathElement,
        E edge,
        double cost,
        double epsilon)
    {
     ...
     */
    BellmanFordPathElement(tilemap.jgrapht.alg.BellmanFordPathElement<V, E> original)
    {
        super(original);
    ...
    protected boolean improve(
        tilemap.jgrapht.alg.BellmanFordPathElement<V, E> candidatePrevPathElement,
        E candidateEdge,
