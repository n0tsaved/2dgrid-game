...
public interface WeightCombiner
{
     ...
     * Sum of weights.
     */
    public tilemap.jgrapht.util.WeightCombiner SUM =
        new tilemap.jgrapht.util.WeightCombiner() {
     ...
     */
    public tilemap.jgrapht.util.WeightCombiner MULT =
        new tilemap.jgrapht.util.WeightCombiner() {
            @Override public double combine(double a, double b)
            {
                return a * b;
     ...
     * Minimum weight.
     */
    public tilemap.jgrapht.util.WeightCombiner MIN =
        new tilemap.jgrapht.util.WeightCombiner() {
            @Override public double combine(double a, double b)
            {
                return Math.min(a, b);
     ...
     * Maximum weight.
     */
    public tilemap.jgrapht.util.WeightCombiner MAX =
        new tilemap.jgrapht.util.WeightCombiner() {
            @Override public double combine(double a, double b)
            {
                return Math.max(a, b);
     ...
     * First weight.
     */
    public tilemap.jgrapht.util.WeightCombiner FIRST =
        new tilemap.jgrapht.util.WeightCombiner() {
            @Override public double combine(double a, double b)
            {
                return a;
     ...
     * Second weight.
     */
    public tilemap.jgrapht.util.WeightCombiner SECOND =
        new tilemap.jgrapht.util.WeightCombiner() {
            @Override public double combine(double a, double b)
            {
                return b;
