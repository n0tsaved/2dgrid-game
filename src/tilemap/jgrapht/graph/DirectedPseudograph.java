...
import tilemap.jgrapht.graph.builder.*;
    ...
    implements DirectedGraph<V, E>
{
    ...
    public static <V, E> DirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DirectedPseudograph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DirectedPseudograph<V, E>>(
            new tilemap.jgrapht.graph.DirectedPseudograph<V, E>(edgeClass));
    }

    public static <V, E> DirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DirectedPseudograph<V, E>, ?> builder(EdgeFactory<V, E> ef)
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DirectedPseudograph<V, E>>(
            new tilemap.jgrapht.graph.DirectedPseudograph<V, E>(ef));
    }
}
