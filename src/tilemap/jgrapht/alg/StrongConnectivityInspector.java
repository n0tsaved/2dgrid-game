...
import tilemap.jgrapht.graph.DirectedSubgraph;
import tilemap.jgrapht.graph.EdgeReversedGraph;
 ...
 * call of {@link tilemap.jgrapht.alg.StrongConnectivityInspector#stronglyConnectedSets()} or {@link
 * tilemap.jgrapht.alg.StrongConnectivityInspector#isStronglyConnected()}.</p>
 *
...
public class StrongConnectivityInspector<V, E> implements StrongConnectivityAlgorithm<V,E>
{
     ...
     * tilemap.jgrapht.alg.StrongConnectivityInspector#stronglyConnectedSets()}. If you don't need
