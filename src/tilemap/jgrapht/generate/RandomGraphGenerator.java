 ...
 * -------
 */
package tilemap.jgrapht.generate;

import tilemap.jgrapht.Graph;
import tilemap.jgrapht.VertexFactory;
import tilemap.jgrapht.graph.DefaultDirectedGraph;
import tilemap.jgrapht.graph.SimpleDirectedGraph;
import tilemap.jgrapht.graph.SimpleGraph;
    ...
    implements GraphGenerator<V, E, V>
{
     ...
     * aNumOfVertexes.
     * tilemap.jgrapht.generate.RandomGraphGenerator.DefaultEdgeTopologyFactory#isNumberOfEdgesValid(tilemap.jgrapht.Graph,
     * int)
     *
        ...
        Map<String, V> resultMap)
    {
        ...
        if (!edgesFactory.isNumberOfEdgesValid(target, numOfEdges)) {
            throw new IllegalArgumentException(
                ...
                + " tilemap.jgrapht.generate.RandomGraphGenerator.DefaultEdgeTopologyFactory");
        }
        ...
        implements EdgeTopologyFactory<VV, EE>
    {
         ...
         * </table>
         *
         * @see tilemap.jgrapht.generate.RandomGraphGenerator.EdgeTopologyFactory#isNumberOfEdgesValid(Graph,
         * int)
         */
