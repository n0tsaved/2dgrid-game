    ...
    implements DirectedGraph<V, E>
{
    ...
    public static <V, E> DirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DefaultDirectedGraph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DefaultDirectedGraph<V, E>>(
            new tilemap.jgrapht.graph.DefaultDirectedGraph<V, E>(edgeClass));
    }
    ...
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DefaultDirectedGraph<V, E>>(
            new tilemap.jgrapht.graph.DefaultDirectedGraph<V, E>(ef));
    }
}
