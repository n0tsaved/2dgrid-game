    ...
    implements WeightedGraph<V, E>
{
    ...
    public static <V, E> UndirectedWeightedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.WeightedPseudograph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new UndirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.WeightedPseudograph<V, E>>(
                new tilemap.jgrapht.graph.WeightedPseudograph<V, E>(edgeClass));
    }

    public static <V, E> UndirectedWeightedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.WeightedPseudograph<V, E>, ?> builder(EdgeFactory<V, E> ef)
    {
        return new UndirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.WeightedPseudograph<V, E>>(
                new tilemap.jgrapht.graph.WeightedPseudograph<V, E>(ef));
    }
}
