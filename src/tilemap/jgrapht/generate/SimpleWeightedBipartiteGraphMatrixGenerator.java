    ...
    extends WeightedGraphGeneratorAdapter<V, E, V>
{
    ...
    public tilemap.jgrapht.generate.SimpleWeightedBipartiteGraphMatrixGenerator<V, E> first(
    ...
    public tilemap.jgrapht.generate.SimpleWeightedBipartiteGraphMatrixGenerator<V, E> second(
