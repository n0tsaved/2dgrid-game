 ...
 *
 */
package tilemap.jgrapht.graph.builder;
...
public final class UndirectedGraphBuilder<V, E, G extends UndirectedGraph<V, E>>
    extends UndirectedGraphBuilderBase<V, E, G, tilemap.jgrapht.graph.builder.UndirectedGraphBuilder<V, E, G>>
{
    ...
    @Override protected tilemap.jgrapht.graph.builder.UndirectedGraphBuilder<V, E, G> self()
    {
        return this;
    }
}
