    ...
    implements DirectedGraph<V, E>
{
    ...
    public static <V, E> DirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DirectedMultigraph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DirectedMultigraph<V, E>>(
            new tilemap.jgrapht.graph.DirectedMultigraph<V, E>(edgeClass));
    }

    public static <V, E> DirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DirectedMultigraph<V, E>, ?> builder(EdgeFactory<V, E> ef)
    {
        return new DirectedGraphBuilder<V, E, tilemap.jgrapht.graph.DirectedMultigraph<V, E>>(
            new tilemap.jgrapht.graph.DirectedMultigraph<V, E>(ef));
    }
}
