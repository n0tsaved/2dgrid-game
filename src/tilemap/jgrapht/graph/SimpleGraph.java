    ...
    implements UndirectedGraph<V, E>
{
    ...
    public static <V, E> UndirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.SimpleGraph<V, E>, ?> builder(Class<? extends E> edgeClass)
    {
        return new UndirectedGraphBuilder<V, E, tilemap.jgrapht.graph.SimpleGraph<V, E>>(
            new tilemap.jgrapht.graph.SimpleGraph<V, E>(edgeClass));
    }

    public static <V, E> UndirectedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.SimpleGraph<V, E>, ?> builder(EdgeFactory<V, E> ef)
    {
        return new UndirectedGraphBuilder<V, E, tilemap.jgrapht.graph.SimpleGraph<V, E>>(
            new tilemap.jgrapht.graph.SimpleGraph<V, E>(ef));
    }
}
