 ...
 *
 */
package tilemap.jgrapht.traverse;

import tilemap.jgrapht.*;
import tilemap.jgrapht.util.*;
import tilemap.jgrapht.alg.KosarajuStrongConnectivityInspector;
 ...
 * consider using {@link tilemap.jgrapht.alg.CycleDetector} or {@link
    ...
    extends CrossComponentIterator<V, E, Object>
{
    ...
    // top-level in tilemap.jgrapht.util if anyone else needs it.
