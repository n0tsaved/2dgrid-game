...
public final class DirectedWeightedGraphBuilder<V,
    ...
    extends DirectedWeightedGraphBuilderBase<V,
        E, G, tilemap.jgrapht.graph.builder.DirectedWeightedGraphBuilder<V, E, G>>
{
    ...
    @Override protected tilemap.jgrapht.graph.builder.DirectedWeightedGraphBuilder<V, E, G> self()
    {
        return this;
    }
}
