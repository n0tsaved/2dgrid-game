    ...
    implements WeightedGraph<V, E>
{
    ...
    public static <V, E> DirectedWeightedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DirectedWeightedMultigraph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new DirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.DirectedWeightedMultigraph<V, E>>(
                new tilemap.jgrapht.graph.DirectedWeightedMultigraph<V, E>(edgeClass));
    }
        ...
        EdgeFactory<V, E> ef)
    {
        return new DirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.DirectedWeightedMultigraph<V, E>>(
                new tilemap.jgrapht.graph.DirectedWeightedMultigraph<V, E>(ef));
    }
}
