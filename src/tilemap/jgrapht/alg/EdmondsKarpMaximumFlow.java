...
import tilemap.jgrapht.alg.interfaces.MaximumFlowAlgorithm;
...
/**
 * @deprecated Use {@link tilemap.jgrapht.alg.flow.EdmondsKarpMaximumFlow} instead
 */
@Deprecated
public final class EdmondsKarpMaximumFlow<V, E> implements MaximumFlowAlgorithm<V, E>
{
    private tilemap.jgrapht.alg.flow.EdmondsKarpMaximumFlow<V, E> engine;

    private MaximumFlow<V, E> maxFlow;
    ...
    {
        engine = new tilemap.jgrapht.alg.flow.EdmondsKarpMaximumFlow<V, E>(network, epsilon);
    }
