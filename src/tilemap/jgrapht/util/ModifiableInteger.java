...
public class ModifiableInteger
    extends Number
    implements Comparable<tilemap.jgrapht.util.ModifiableInteger>
{
     ...
     * (signed comparison).
     */
    @Override public int compareTo(tilemap.jgrapht.util.ModifiableInteger anotherInteger)
    {
    ...
    {
        if (o instanceof tilemap.jgrapht.util.ModifiableInteger) {
            return this.value == ((tilemap.jgrapht.util.ModifiableInteger) o).value;
        }
