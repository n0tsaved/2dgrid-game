...
public final class DirectedGraphBuilder<V, E, G extends DirectedGraph<V, E>>
    extends DirectedGraphBuilderBase<V, E, G, tilemap.jgrapht.graph.builder.DirectedGraphBuilder<V, E, G>>
{
    ...
    @Override protected tilemap.jgrapht.graph.builder.DirectedGraphBuilder<V, E, G> self()
    {
        return this;
    }
}
