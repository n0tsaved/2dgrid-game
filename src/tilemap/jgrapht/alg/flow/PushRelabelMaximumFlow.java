 ...
 * -------
 */
package tilemap.jgrapht.alg.flow;

import tilemap.jgrapht.alg.util.Extension.ExtensionFactory;
import tilemap.jgrapht.DirectedGraph;
import tilemap.jgrapht.alg.util.Pair;
    ...
    public PushRelabelMaximumFlow(DirectedGraph<V, E> network) {
        ...
        this.vertexExtensionsFactory = new ExtensionFactory<VertexExtension>() {
            ...
            public VertexExtension create() {
                return tilemap.jgrapht.alg.flow.PushRelabelMaximumFlow.this.new VertexExtension();
            }
        };
        ...
        this.edgeExtensionsFactory = new ExtensionFactory<EdgeExtension>() {
            ...
            public EdgeExtension create() {
                return tilemap.jgrapht.alg.flow.PushRelabelMaximumFlow.this.new EdgeExtension();
            }
        };
