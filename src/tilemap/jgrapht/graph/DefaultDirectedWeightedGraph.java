    ...
    implements WeightedGraph<V, E>
{
    ...
    public static <V, E> DirectedWeightedGraphBuilderBase<V,
        E, ? extends tilemap.jgrapht.graph.DefaultDirectedWeightedGraph<V, E>, ?> builder(
        Class<? extends E> edgeClass)
    {
        return new DirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.DefaultDirectedWeightedGraph<V, E>>(
                new tilemap.jgrapht.graph.DefaultDirectedWeightedGraph<V, E>(edgeClass));
    }
        ...
        EdgeFactory<V, E> ef)
    {
        return new DirectedWeightedGraphBuilder<V,
            E, tilemap.jgrapht.graph.DefaultDirectedWeightedGraph<V, E>>(
                new tilemap.jgrapht.graph.DefaultDirectedWeightedGraph<V, E>(ef));
    }
}
